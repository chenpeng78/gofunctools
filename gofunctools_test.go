...
func TestFile(t *testing.T) {
	...
	equal(t, "gofunctools.go", Basename("/home/go/src/pkg/gofunctools.go"))

	tPathinfo := Pathinfo("/home/go/gofunctools.go.go", -1)
	equal(t, map[string]string{"dirname": "/home/go", "basename": "gofunctools.go.go", "extension": "go", "filename": "gofunctools.go"}, tPathinfo)
